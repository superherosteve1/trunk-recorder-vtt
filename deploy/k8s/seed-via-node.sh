...
NODE="${NODE:-billbixby@192.168.8.204}"
...
sudo chmod -R a+rX "$REMOTE_MNT/talk_groups.csv" "$REMOTE_MNT/districts.json" "$REMOTE_MNT/trunk-recorder.json" "$REMOTE_MNT/gis" "$REMOTE_MNT/docs" || true
echo "Seeded:"
ls -la "$REMOTE_MNT"
